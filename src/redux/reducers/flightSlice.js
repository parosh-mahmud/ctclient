...
// import { createSlice, createAsyncThunk } from "@reduxjs/toolkit";
// import axios from "axios";
// import airports from "../../components/FlightSearch/data/Airport"; // Adjust the import path as necessary
...
// export const fetchFlightResults = createAsyncThunk(
//   "flight/fetchFlightResults",
//   async ({ flyHubRequest, bdfareRequest }, { rejectWithValue }) => {
//     try {
//       const response = await axios.post(`${BASE_URL}/api/airSearch`, {
//         flyHubRequest,
//         bdfareRequest,
//       });
//       return {
//         data: response.data,
//         searchParams: { flyHubRequest, bdfareRequest },
//       }; // Return both data and searchParams
//     } catch (error) {
//       return rejectWithValue(
//         error.response?.data || error.message || "Something went wrong"
//       );
